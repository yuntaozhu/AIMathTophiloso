...
export const RAG_THESIS_REGISTRY: Record<string, Partial<RagLiteratureThesis>> = {
  ...
  'doc-aicoding-01': {
    sourceTitle: '控制权往哪里移：AI Coding 的工程演变',
    authors: 'Ethan Jiang',
    year: 2026,
    sectionOrPage: 'Five Paradigms（PDF/AI-Coding.pdf）',
    targetSlideIndex: 17,
    targetSlideTitle: '方法论收束：Agent = Model + Harness',
    keywords: ['Harness', 'Prompt', 'Context', 'Loop', 'Graph'],
    ontologicalParadigm: '科学哲学与方法论',
    coreThesis: '控制权逐步外移：Prompt/Context 管生成，Harness/Loop/Graph 才管执行能否发生。',
    epistemicMappingToSlide: '支撑收束页五类范式谱系与“管生成≠管执行”。'
  },
  'doc-aicoding-02': {
    sourceTitle: 'Agent = Model + Harness：那一圈决定交付差距',
    authors: 'Ethan Jiang / Böckeler / Codex harness 证据',
    year: 2026,
    sectionOrPage: 'Harness Matters（PDF/AI-Coding.pdf）',
    targetSlideIndex: 17,
    targetSlideTitle: '方法论收束：Agent = Model + Harness',
    keywords: ['Agent = Model + Harness', '验证门禁', 'ARC-AGI'],
    ontologicalParadigm: '科学哲学与方法论',
    coreThesis: '同一模型换 harness，交付成功率与成本可差数倍；能力看模型，差距看那一圈。',
    epistemicMappingToSlide: '直接锚定公式页与证据链。'
  },
  'doc-boeckeler-harness-01': {
    sourceTitle: 'Harness engineering for coding agent users',
    authors: 'Birgitta Böckeler',
    year: 2026,
    sectionOrPage: 'martinfowler.com article',
    targetSlideIndex: 17,
    targetSlideTitle: '方法论收束：Agent = Model + Harness',
    keywords: ['Harness', 'coding agent', 'feedforward', 'feedback'],
    ontologicalParadigm: '科学哲学与方法论',
    coreThesis: 'Harness 是智能体中除模型外的一切；用户侧外圈 harness 决定可信度。',
    epistemicMappingToSlide: '公式原典引文来源。'
  },
  'doc-alphaproof-imo-01': {
    sourceTitle: 'AI achieves silver-medal standard solving IMO problems',
    authors: 'AlphaProof and AlphaGeometry teams (DeepMind)',
    year: 2024,
    sectionOrPage: 'DeepMind blog 2024-07-25',
    targetSlideIndex: 4,
    targetSlideTitle: '核心反差：数学已有范式突破，文社哲尚未有',
    keywords: ['AlphaProof', 'AlphaGeometry 2', 'IMO', '银牌'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '形式化数学推理系统在 IMO 2024 达到银牌水准，构成可公开复核的数学侧突破。',
    epistemicMappingToSlide: '开场反差页的数学侧证据。'
  },
  'doc-alphageometry2-01': {
    sourceTitle: 'AlphaGeometry2 gold-medalist Olympiad geometry',
    authors: 'Chervonyi, Trinh et al. (DeepMind)',
    year: 2025,
    sectionOrPage: 'Abstract',
    targetSlideIndex: 4,
    targetSlideTitle: '核心反差：数学已有范式突破，文社哲尚未有',
    keywords: ['AlphaGeometry2', 'IMO', 'geometry'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: 'AG2 将近 25 年奥赛几何题求解率从 54% 提升至 84%，并参与 IMO 银牌系统。',
    epistemicMappingToSlide: '开场 AlphaGeometry 叙事。'
  },
  'doc-leandojo-01': {
    sourceTitle: 'LeanDojo: Theorem Proving with Retrieval-Augmented Language Models',
    authors: 'Kaiyu Yang et al.',
    year: 2023,
    sectionOrPage: 'Abstract',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['LeanDojo', 'ReProver', 'Lean'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '开放 Lean 交互与前提检索使 LLM 定理证明可复现研究。',
    epistemicMappingToSlide: 'P.3 Lean 生态文献。'
  },
  'doc-deepseek-prover-01': {
    sourceTitle: 'DeepSeek-Prover-V1.5',
    authors: 'DeepSeek-AI',
    year: 2024,
    sectionOrPage: 'Abstract',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['DeepSeek-Prover', 'RLPAF', 'Lean 4'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '证明助手反馈进入 RL/MCTS，提升 Lean 4 自动证明。',
    epistemicMappingToSlide: 'P.3 / Harness 反馈环对照。'
  },
  'doc-goedel-prover-01': {
    sourceTitle: 'Goedel-Prover',
    authors: 'Yong Lin, Shange Tang, Kaiyu Yang et al.',
    year: 2025,
    sectionOrPage: 'Abstract',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['Goedel-Prover', 'autoformalization', 'miniF2F'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '大规模自动形式化 + 证明自举构成开源 ATP 数据飞轮。',
    epistemicMappingToSlide: 'Lean ATP 生态。'
  },
  'doc-cordoba-cascade-01': {
    sourceTitle: 'Córdoba–Martínez-Zoroa forced 3D Euler blow-up',
    authors: 'Diego Córdoba, Luis Martínez-Zoroa',
    year: 2023,
    sectionOrPage: 'arXiv:2309.08495',
    targetSlideIndex: 2,
    targetSlideTitle: '时代背景：2026年数学界的“深蓝时刻”',
    keywords: ['3D Euler', 'blow-up', 'forcing', 'Córdoba'],
    ontologicalParadigm: '无限维偏微分方程与相变',
    coreThesis: '低正则均匀外力下构造三维欧拉爆破，构成后续光滑外力突破的纲领源流。',
    epistemicMappingToSlide: 'P.2 纲领溯源。'
  },
  'doc-generative-agents-pdf': {
    sourceTitle: 'Generative Agents: Interactive Simulacra of Human Behavior',
    authors: 'Joon Sung Park et al.',
    year: 2023,
    sectionOrPage: 'Abstract',
    targetSlideIndex: 50,
    targetSlideTitle: 'Social Simulacra：社会试运行与多宇宙推演',
    keywords: ['Generative Agents', 'Smallville', 'memory stream'],
    ontologicalParadigm: '分布式多智能体与博弈',
    coreThesis: '记忆流·反思·规划使沙盒智能体呈现可信人类行为模拟。',
    epistemicMappingToSlide: '多智能体章节 PDF 底本。'
  },
  'doc-shiu-fly-01': {
    sourceTitle: 'A Drosophila computational brain model (Nature 2024)',
    authors: 'Philip K. Shiu et al.',
    year: 2024,
    sectionOrPage: 'Nature 2024',
    targetSlideIndex: 50,
    targetSlideTitle: 'Social Simulacra：社会试运行与多宇宙推演',
    keywords: ['Drosophila', 'connectome', 'Nature'],
    ontologicalParadigm: '分布式多智能体与博弈',
    coreThesis: '全脑连接组计算模型揭示感觉运动通路，支撑具身仿真祛魅。',
    epistemicMappingToSlide: '数字苍蝇真源。'
  },
  'doc-friedman-pdf-01': {
    sourceTitle: 'Friedman Boolean Relation Theory / Concrete Incompleteness manuscripts',
    authors: 'Harvey M. Friedman',
    year: 2011,
    sectionOrPage: 'OSU downloadable manuscripts',
    targetSlideIndex: 22,
    targetSlideTitle: '哈维·弗里德曼与“具体数学不完备性”',
    keywords: ['concrete incompleteness', 'Boolean Relation Theory', 'Friedman'],
    ontologicalParadigm: '数理逻辑与模型论',
    coreThesis: '具体组合命题可具有大基数级证明强度。',
    epistemicMappingToSlide: '弗里德曼专章 PDF 底本。'
  },
  'doc-fsm-trading-01': {
    sourceTitle: '基于 FSM 与独立出场引擎的量化交易重构',
    authors: '量化交易重构方案',
    year: 2026,
    sectionOrPage: '全文',
    targetSlideIndex: 16,
    targetSlideTitle: '架构融合：Type-3 结构发现 Harness',
    keywords: ['FSM', '出场引擎', '解耦'],
    ontologicalParadigm: '科学哲学与方法论',
    coreThesis: '门禁（出场）与提案（进场）状态机解耦，防止死锁。',
    epistemicMappingToSlide: '可执行认识论/状态机样板。'
  },
  'doc-futures-01': {
    sourceTitle: '复数未来与未来研究',
    authors: '后AI研究所',
    year: 2026,
    sectionOrPage: '导言 / JFS',
    targetSlideIndex: 50,
    targetSlideTitle: 'Social Simulacra：社会试运行与多宇宙推演',
    keywords: ['复数未来', 'Futures Literacy', '反事实'],
    ontologicalParadigm: '一般认识论',
    coreThesis: '未来研究是使用未来的能力，而非单点预测。',
    epistemicMappingToSlide: '多宇宙/反事实叙事语法。'
  },
  'doc-react-01': {
    sourceTitle: 'ReAct: Synergizing Reasoning and Acting in Language Models',
    authors: 'Shunyu Yao et al.',
    year: 2023,
    sectionOrPage: 'arXiv:2210.03629',
    targetSlideIndex: 17,
    targetSlideTitle: '方法论收束：Agent = Model + Harness',
    keywords: ['ReAct', 'tool use', 'LLM agent'],
    ontologicalParadigm: '科学哲学与方法论',
    coreThesis: '推理与行动交织使语言模型成为可接地的目标驱动智能体。',
    epistemicMappingToSlide: 'Harness 工具环的经典起点。'
  },
  'doc-reflexion-01': {
    sourceTitle: 'Reflexion: Language Agents with Verbal Reinforcement Learning',
    authors: 'Noah Shinn, Shunyu Yao et al.',
    year: 2023,
    sectionOrPage: 'arXiv:2303.11366',
    targetSlideIndex: 17,
    targetSlideTitle: '方法论收束：Agent = Model + Harness',
    keywords: ['Reflexion', 'verbal RL', 'memory'],
    ontologicalParadigm: '科学哲学与方法论',
    coreThesis: '用语言反思与情景记忆实现可失败改进，无需改权重。',
    epistemicMappingToSlide: 'Harness 反馈/记忆层。'
  },
  'doc-sweagent-01': {
    sourceTitle: 'SWE-agent: Agent-Computer Interfaces',
    authors: 'John Yang, Ofir Press et al.',
    year: 2024,
    sectionOrPage: 'arXiv:2405.15793',
    targetSlideIndex: 17,
    targetSlideTitle: '方法论收束：Agent = Model + Harness',
    keywords: ['SWE-agent', 'ACI', 'Harness'],
    ontologicalParadigm: '科学哲学与方法论',
    coreThesis: '为 LM agent 定制计算机接口显著提升软件工程成功率——差距在接口不在模型口号。',
    epistemicMappingToSlide: '公式“差距看那一圈”的工程证据。'
  },
  'doc-minif2f-01': {
    sourceTitle: 'miniF2F formal olympiad benchmark',
    authors: 'Zheng, Han, Polu',
    year: 2022,
    sectionOrPage: 'arXiv:2109.00110',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['miniF2F', 'Lean', 'ATP'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '跨证明助手的奥赛级形式题库，成为神经定理证明共用标尺。',
    epistemicMappingToSlide: 'P.3 ATP 生态。'
  },
  'doc-mathlib-01': {
    sourceTitle: 'The Lean Mathematical Library (mathlib)',
    authors: 'mathlib Community',
    year: 2020,
    sectionOrPage: 'arXiv:1910.09336',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['mathlib', 'Lean'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '社区维护的大规模 Lean 数学库是形式化证明的基础设施。',
    epistemicMappingToSlide: 'Lean 引理宇宙。'
  },
  'doc-hypertree-01': {
    sourceTitle: 'HyperTree Proof Search for Neural Theorem Proving',
    authors: 'Lample et al. (Meta)',
    year: 2022,
    sectionOrPage: 'arXiv:2205.11491',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['HyperTree', 'proof search', 'AlphaZero'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: 'AlphaZero 风格在线证明搜索显著提升形式定理证明率。',
    epistemicMappingToSlide: '神经×形式闭环。'
  },
  'doc-llemma-01': {
    sourceTitle: 'LLEMMA: An Open Language Model for Mathematics',
    authors: 'Azerbayev, Welleck et al.',
    year: 2024,
    sectionOrPage: 'arXiv:2310.10631',
    targetSlideIndex: 4,
    targetSlideTitle: '核心反差：数学已有范式突破，文社哲尚未有',
    keywords: ['LLEMMA', 'MATH', 'open LM'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '开放数学专用 LM，可工具使用与形式证明。',
    epistemicMappingToSlide: '数学侧开放模型证据。'
  },
  'doc-deepseekmath-01': {
    sourceTitle: 'DeepSeekMath',
    authors: 'DeepSeek-AI',
    year: 2024,
    sectionOrPage: 'arXiv:2402.03300',
    targetSlideIndex: 4,
    targetSlideTitle: '核心反差：数学已有范式突破，文社哲尚未有',
    keywords: ['DeepSeekMath', 'GRPO', 'MATH'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '大规模数学语料 + GRPO 将开源模型推向竞赛级 MATH 表现。',
    epistemicMappingToSlide: '开源数学推理突破。'
  },
  'doc-process-supervision-01': {
    sourceTitle: "Let's Verify Step by Step",
    authors: 'Lightman, Cobbe et al. (OpenAI)',
    year: 2023,
    sectionOrPage: 'arXiv:2305.20050',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['process supervision', 'MATH'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '逐步过程监督优于结果监督——自然语言侧的逐步核验。',
    epistemicMappingToSlide: '对照 Lean 逐步类型检查。'
  },
  'doc-atp-survey-01': {
    sourceTitle: 'A Survey on Deep Learning for Theorem Proving',
    authors: 'Li, Yang, Si et al.',
    year: 2024,
    sectionOrPage: 'arXiv:2404.09939',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['survey', 'theorem proving', 'ATP'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '系统综述自动形式化、前提选择、证明搜索等任务。',
    epistemicMappingToSlide: 'ATP 地图。'
  },
  'doc-minictx-01': {
    sourceTitle: 'miniCTX: Neural Theorem Proving with Contexts',
    authors: 'Hu, Zhu, Welleck et al.',
    year: 2025,
    sectionOrPage: 'arXiv:2408.03191',
    targetSlideIndex: 3,
    targetSlideTitle: 'Lean 是什么：交互式证明器与 0/1 真值机',
    keywords: ['miniCTX', 'context', 'NTP'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '长上下文神经定理证明更接近真实 Mathlib 工程。',
    epistemicMappingToSlide: '形式化工程语境。'
  },
  'doc-olympiadbench-01': {
    sourceTitle: 'OlympiadBench',
    authors: 'He, Han, Liu, Sun et al.',
    year: 2024,
    sectionOrPage: 'arXiv:2402.14008',
    targetSlideIndex: 4,
    targetSlideTitle: '核心反差：数学已有范式突破，文社哲尚未有',
    keywords: ['OlympiadBench', 'olympiad', 'AGI'],
    ontologicalParadigm: '数理逻辑与形式化方法',
    coreThesis: '奥赛级双语多模态科学题成为 AGI 压力测试标尺。',
    epistemicMappingToSlide: '奥赛难度叙事。'
  },
  'doc-social-simulacra-01': {
    sourceTitle: 'Social Simulacra',
    authors: 'Park et al.',
    year: 2022,
    sectionOrPage: 'arXiv:2208.04024',
    targetSlideIndex: 50,
    targetSlideTitle: 'Social Simulacra：社会试运行与多宇宙推演',
    keywords: ['Social Simulacra', 'What-If'],
    ontologicalParadigm: '分布式多智能体与博弈',
    coreThesis: '用 LM 填充社会计算原型，在建成前探索社区行为。',
    epistemicMappingToSlide: 'P.50 直接对应。'
  },
  'doc-machiavelli-01': {
    sourceTitle: 'MACHIAVELLI benchmark',
    authors: 'Pan, Hendrycks et al.',
    year: 2023,
    sectionOrPage: 'arXiv:2304.03279',
    targetSlideIndex: 56,
    targetSlideTitle: '反击“RLHF 中庸偏置（Politeness Bias）”：剥除虚伪温情',
    keywords: ['MACHIAVELLI', 'ethics', 'power-seeking'],
    ontologicalParadigm: '分布式多智能体与博弈',
    coreThesis: '奖励最大化与伦理行为存在可测张力；智能体可学到马基雅维利策略。',
    epistemicMappingToSlide: 'P.56–57 马基雅维利底色。'
  },
  'doc-causal-adj-01': {
    sourceTitle: 'Efficient adjustment sets in causal graphical models',
    authors: 'Smucler, Sapienza, Rotnitzky',
    year: 2020,
    sectionOrPage: 'arXiv:2004.10521',
    targetSlideIndex: 51,
    targetSlideTitle: '形式化审查进入社科：从数学证明到历史因果闭环',
    keywords: ['causal', 'SCM', 'adjustment'],
    ontologicalParadigm: '一般认识论',
    coreThesis: '含隐变量因果图中的有效调整集理论支撑结构因果建模。',
    epistemicMappingToSlide: 'P.51 因果图语言。'
  },
  'doc-godel-ontological-01': {
    sourceTitle: "Formalization of Gödel’s Ontological Proof",
    authors: 'Benzmüller, Paleo',
    year: 2013,
    sectionOrPage: 'arXiv:1308.4526',
    targetSlideIndex: 70,
    targetSlideTitle: '哥德尔模态逻辑与本体论论证：正向属性与必然存在闭环',
    keywords: ['Gödel', 'ontological argument', 'modal logic'],
    ontologicalParadigm: '数理逻辑与模型论',
    coreThesis: '高阶逻辑可机械化检验哥德尔本体论论证。',
    epistemicMappingToSlide: 'P.70 直接对应。'
  },
  'doc-friedman-01': {
